...
//#endif
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		{
			view = glm::lookAt(glm::vec3(0.0f, 3.0f, 3.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
...
int setupGeometry()
{
	...
	GLuint VBO, VAO; //Geração do identificador do VBO
	glGenBuffers(1, &VBO);

	//Faz a conexão (vincua) do, buffer como um buffer de array
